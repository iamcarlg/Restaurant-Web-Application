                ...
                <div class="row">
                  <div class=" col-md-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <form class="main_form" action = "session_action.php" method = "POST" >
                            <div class="row">
...
/* 
SELECT acc_pseudo, usr_statut FROM t_userprofile_usr
JOIN t_useraccount_acc USING (acc_pseudo)
WHERE acc_pseudo = 'Alpha18' and usr_validity = 'A'
