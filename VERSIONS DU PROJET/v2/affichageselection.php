...
//Affichage de la table présentation
...
{
    //RECUPERATION DE L'ELEMENT 1 ET LA SELECTION 1
    $sid = $_GET['sel_id'];
    $eid = $_GET['elt_id'];

    $req = "SELECT * FROM t_selection_sel WHERE sel_number = ".$sid."";
    ...
    echo ('<center style = "font-size:20px; font-style:italic; font-family:Lato"> " ' .$sel['sel_introText']. ' "</center>');

    echo '<br><br>';

    echo ('<center style = "font-weight:bolder; font-size:20px; ">'.$eid. ') ' . $el['el_title']. '</center><br>');

    echo ("<center><img width='400' src='./images/". $el['el_image'] ."'></center>");
    ...
    if($result2->num_rows && $result3->num_rows){
        ...
        echo '<li class = "button_user" style = "margin-left:580px;" padding-left:50px;>'; echo ("<a class = 'button' href = './affichageselection.php?sel_id=".$sel['sel_number']."&elt_id=".$prec['el_number']."' style = \'color:blue; padding-right:100px;\' >Previous</a>"); echo '</li>';
        echo '<li class = "button_user" style = "margin-left:580px;">'; echo ("<a class = 'button' href = './affichageselection.php?sel_id=".$sel['sel_number']."&elt_id=".$suiv['el_number']."' style = \'color:blue;\' >Next</a>"); echo '</li>';

        exit();
        
    }else if($result2->num_rows){
        echo '<li class = "button_user" style = "margin-left:580px;">'; echo ("<a class = 'button' href = './affichageselection.php?sel_id=".$sel['sel_number']."&elt_id=".$prec['el_number']."' style = \'color:blue; padding-right:100px;\' >Previous</a>"); echo '</li>';
        exit();
